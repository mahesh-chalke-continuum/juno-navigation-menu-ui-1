    ...
    return (
      ...
      >
        <a
          ...
          className={
            "menu-item-level-1-link" +
            (this.props.customerLogo ? " no-bottom-highlight" : "")
          }
        >
        ...
        {this.props.childItems &&
          this.props.childItems.length > 0 && (
              ...
              <div className="grouped-menu-item-level-2-container">
                ...
                <div className="grouped-menu-item-level-2-callout">
                  {this.state.calloutItems.length > 0
                    ? this.state.calloutItems.map(co => (
                        <SimpleMenuItemLevel2 {...co} />
                      ))
                    : null}
                </div>
              </div>
